...
const word_list_cro = [
"aerob", "afera", "afiks", "agama", "agava", "agent", "agora", "agrar", "agrum", "akord", "aktiv", "alarm", 
"album", "aleja", "alibi", "aljkav", "alkan", "alkar", "alken", "alkin", "ambon", "ameba", "amper", "anion", 
"anoda", "anđeo", "aorta", "arbun", "arena", "argon", "arhea", "arhiv", "arija", "aroma", "arsen", "asket", 
"astat", "astma", "atelje", "atlas", "atrij", "augur", "autor", "avion", "babić", "bacač", "bacil", "badem", 
"badnji", "bager", "bahat", "bajam", "bajka", "bakar", "baklja", "balet", "balon", "balun", "banda", "banka", 
"barba", "barem", "barij", "barka", "barok", "barun", "barut", "basna", "batić", "bazen", "bazga", "bazni", 
"bačva", "bedem", "bedro", "berač", "berba", "beton", "bezub", "bećar", "biber", "bijeg", "bijel", "bijes", 
"biljeg", "biljka", "biljni", "birač", "biser", "bista", "bitan", "bitka", "bivol", "bivši", "bizon", "bičaš", 
"blago", "blanja", "blato", "blizu", "bluza", "bodež", "bodlja", "bofor", "bogac", "bogat", "bojna", "bojni", 
"bolan", "bolid", "bomba", "bongo", "borac", "borba", "borni", "borov", "bosti", "boćar", "bočat", "bočni", 
"bočno", "božić", "božji", "braco", "brada", "brana", "branje", "brati", "brava", "bravo", "braća", "breka", 
"breme", "brend", "breza", "brico", "briga", "brkat", "brklja", "brlog", "bronh", "brtva", "brvno", "brzac", 
"budan", "buhač", "bujan", "buket", "bukov", "bukva", "bulin", "bunar", "bunda", "burag", "buran", "burek", 
"burin", "burno", "burza", "busen", "butan", "bučan", "bučno", "bušik", "bušin", "carev", "cedar", "cekin", 
"celer", "centa", "cesta", "cezij", "cigla", "cijel", "cijep", "cijev", "cikas", "cikla", "ciljni", "cimet", 
"cinik", "cipal", "cista", "citat", "citra", "civil", "crkva", "crnac", "crnka", "crpka", "crtač", "crtež", 
"crtić", "crven", "crvić", "dabar", "dagnja", "dakle", "dalek", "daljnji", "danak", "danas", "daska", "dativ", 
"datum", "davež", "davni", "davno", "dašak", "debeo", "debil", "deblo", "dekan", "dekor", "delta", "demon", 
"demos", "deran", "deset", "desni", "desno", "devet", "devon", "dečko", "diljem", "dinar", "dingo", "dioba", 
"dioda", "diple", "divan", "divlji", "divno", "dizač", "dizel", "dičan", "dišni", "djeca", "djelo", "dlaka", 
"dobar", "dobit", "dobni", "dobro", "dodir", "dogma", "dojam", "dojka", "dokad", "dokaz", "dokle", "dokon", 
"dokud", "dolar", "domar", "domet", "donle", "dopis", "dosad", "doseg", "dosje", "dosta", "dotad", "dotle", 
"dotok", "dovde", "dovle", "dovod", "dovoz", "doček", "dočim", "draga", "drago", "drama", "drača", "dreka", 
"drmeš", "droga", "drozd", "drsko", "drugi", "drvce", "drven", "drvlje", "drvni", "drzak", "drška", "držak", 
"držač", "dubok", "dudaš", "dudov", "dugme", "duhan", "dukat", "dupin", "duplja", "dućan", "dušik", "dušni", 
"dužan", "dveri", "dvica", "dvije", "dvoje", "dvoji", "dželat", "džepar", "džepni", "džezva", "džihad", "džokej", 
"džudaš", "edikt", "efekt", "egzem", "ekcem", "ekipa", "ekran", "elisa", "elita", "emajl", "endem", "enzim", 
"eocen", "epika", "epoha", "epski", "ester", "estet", "etapa", "etaža", "etika", "etnik", "eunuh", "fagot", 
"fakir", "farad", "farma", "fauna", "fazan", "felah", "fenjer", "feral", "fetus", "fikus", "firma", "fjeld", 
"fjord", "flora", "flota", "fluid", "fluor", "foaje", "fokus", "fonem", "forma", "forum", "fosil", "foton", 
"fraza", "freon", "front", "frula", "futur", "gadan", "gajde", "galeb", "galop", "gamad", "ganga", "garav", 
"garda", "garig", "gatar", "gaučo", "gavun", "gazda", "gačac", "gejša", "genij", "genom", "geslo", "gesta", 
"gibak", "gibon", "gilda", "ginko", "glava", "glede", "glina", "gljiva", "gluma", "glupo", "gnjida", "gnoma", 
"golać", "golem", "golet", "golub", "gonič", "gorak", "gorje", "gorko", "gornji", "gosp.", "gospa", "gotov", 
"govno", "govor", "gozba", "gošća", "graja", "grana", "granje", "građa", "grbav", "grdan", "grdno", "greda", "grejp", 
"grgeč", "grifo", "grinja", "gripa", "griva", "griža", "grlat", "grlen", "grlić", "grmić", "grmlje", "groza", 
"grozd", "grubo", "gruda", "grudi", "grupa", "grčki", "gubar", "gubav", "gudač", "gulag", "gulaš", "gumar", 
"gumen", "gumno", "gusak", "gusar", "guska", "gusle", "gutač", "gušav", "gužva", "gvalja", "gđica", "habit", 
"haiku", "hajde", "hajka", "haker", "harač", "harem", "harfa", "hašiš", "helij", "heljda", "helot", "henri", 
"heroj", "hidra", "hihot", "himba", "himna", "hitac", "hitan", "hitar", "hitin", "hitnja", "hitno", "hitro", 
"hlače", "hmelj", "hokej", "horda", "hotel", "hrana", "hrast", "hrbat", "hrušt", "hrvač", "hrčak", "hrđav", 
"humak", "human", "humlje", "humor", "humus", "hunta", "hvala", "hvoja", "ideal", "ideja", "idila", "idiom", 
"idiot", "idući", "igdje", "igrač", "ikada", "ikako", "ikoji", "ikona", "ikuda", "imanje", "imati", "imela", 
"inače", "inćun", "irski", "ishod", "iskaz", "iskon", "iskra", "islam", "ispad", "ispis", "ispit", "ispod", 
"istek", "istok", "istom", "ivrit", "izaći", "izbor", "izdah", "izgon", "izići", "izlaz", "izlet", "izljev", 
"izlog", "izmet", "iznad", "iznos", "izraz", "izrez", "izrod", "izuti", "izvan", "izvod", "izvor", "izvoz", 
"ičiji", "jadan", "jahač", "jahta", "jajni", "jakna", "jalov", "jamac", "janjad", "jarac", "jarad", "jarak", 
"jaram", "jarić", "jarki", "jasan", "jasen", "jasle", "jasno", "javni", "javor", "jecaj", "jedak", "jedan", 
"jedar", "jedni", "jedno", "jedro", "jedva", "jelen", "jelka", "jelov", "jesen", "jesti", "jetra", "jezik", 
"jeziv", "ječam", "ježić", "jidiš", "jodni", "jodov", "junac", "junad", "junak", "juriš", "jurta", "juten", 
"jutro", "jučer", "jušni", "južni", "kabao", "kabel", "kadar", "kadet", "kafić", "kajak", "kajda", "kakao", 
"kakav", "kalež", "kalif", "kalij", "kalup", "kamen", "kanal", "kandža", "kanjon", "kanon", "kanta", "kapak", 
"kaplja", "kaput", "karat", "karta", "kasni", "kasno", "kasta", "katar", "katni", "kavez", "kavga", "kazna", 
"kaćun", "kebab", "kefir", "keson", "kicoš", "kifla", "kilav", "kiosk", "kipar", "kiseo", "kisik", "kićen", 
"kičma", "kišan", "kišni", "klada", "klanje", "klapa", "klasa", "klati", "klaun", "kleka", "kleti", "klica", 
"klima", "kljast", "kljova", "kljuse", "klopa", "klupa", "knjiga", "koala", "kobac", "koban", "kobra", "kocka", 
"kojot", "kokos", "kokot", "kokoš", "kolac", "kolač", "kolaž", "kolik", "koljač", "kolni", "kolon", "kolos", 
"kolut", "komad", "kombi", "komet", "konac", "konak", "konge", "konjak", "konjic", "konjić", "konop", "konto", 
"kopar", "kopač", "koplje", "kopno", "kopča", "korak", "koral", "korov", "korzo", "kosac", "kotac", "kotao", 
"kotar", "kotač", "kovač", "kozji", "kozle", "koćar", "kočar", "košer", "košnja", "kožni", "kralj", "kramp", 
"kraul", "krava", "krađa", "krcat", "kreda", "krema", "kreol", "krhak", "krilo", "kriti", "krivo", "kriza", 
"križa", "krmni", "kroza", "krpen", "krsni", "kruna", "krvav", "krvni", "krzno", "krčag", "krčma", "kršan", 
"krški", "kršni", "kubik", "kubni", "kugla", "kuhan", "kuhar", "kukac", "kukma", "kulak", "kulon", "kumin", 
"kumče", "kunić", "kunjad", "kunjka", "kupac", "kupač", "kupka", "kupnja", "kupon", "kupus", "kurac", "kuran", "kutak", 
"kućni", "kušnja", "kvaka", "kvant", "kvarc", "kvart", "kvrga", "labav", "labud", "lagan", "lahor", "lakaj", 
"lakat", "lakom", "lampa", "lanac", "lanad", "lapor", "larva", "laser", "lasta", "lavež", "lavlji", "lavor", 
"lađar", "lažan", "lažno", "leden", "leglo", "lemeš", "lemur", "lenta", "letak", "letač", "letni", "levit", 
"leđni", "ležaj", "lignja", "lihva", "lijek", "lijen", "lijep", "lijes", "liker", "limar", "limen", "limes", 
"limfa", "limun", "linjak", "linđo", "lipid", "lipov", "lisac", "liska", "lisni", "lista", "litij", "litra", 
"lični", "lišaj", "lišce", "lišće", "ljanos", "ljetni", "ljetos", "ljevak", "ljevač", "ljigav", "ljiljan", "ljubak", 
"ljubav", "ljupko", "ljuska", "ljutit", "ljutnja", "logor", "lojni", "lokot", "lokva", "lonac", "lopov", "lopoč", 
"lopta", "losos", "lovac", "lovka", "lovni", "lovor", "lozni", "lozov", "ložač", "lubin", "lugar", "lukav", 
"lupa²", "lutak", "lutka", "lutnja", "lučki", "luđak", "madež", "magla", "magma", "majka", "major", "majur", 
"makar", "malen", "malko", "mamac", "mamut", "mango", "manjak", "marka", "marva", "maser", "masiv", "maska", 
"maslo", "masni", "mason", "mazga", "maziv", "mačak", "mačić", "mačji", "mačka", "mašta", "meden", "medij", 
"medni", "mekan", "meket", "melem", "melez", "menta", "menza", "mesar", "mesni", "mesti", "metak", "metal", 
"metan", "metar", "metež", "metil", "metla", "metro", "međaš", "mijau", "mijeh", "minij", "minus", "miran", 
"miraz", "miris", "mirno", "mirta", "misal", "misao", "misni", "mitra", "mišić", "mišji", "miška", "mjera", 
"mlada", "mlado", "mlaka", "mljeti", "mniti", "mnogi", "mnogo", "mnome", "modar", "model", "modem", "modni", 
"moguć", "mokar", "molba", "moljac", "momak", "monah", "moral", "mosni", "motel", "motet", "motiv", "motka", 
"motor", "mozak", "moćan", "mošnja", "možda", "mrena", "mreža", "mrkli", "mrkva", "mrtav", "mrzak", "mrzao", 
"mršav", "mržnja", "mudar", "mukao", "muklo", "mulat", "murva", "musav", "musti", "mutan", "mutav", "muzej", 
"mučan", "mučno", "muški", "mužar", "mužev", "mužnja", "naboj", "nabor", "nacrt", "nafta", "nagao", "nagib", 
"naglo", "nagon", "nahod", "naime", "naiva", "naići", "najam", "nakit", "nakon", "nalaz", "nalet", "nalik", 
"naljev", "nalog", "namaz", "namet", "namot", "nandu", "nanos", "naoko", "napad", "napet", "napis", "napoj", 
"napon", "napor", "narav", "narod", "nasad", "nasip", "nauka", "navod", "navoj", "nazad", "nazal", "naziv", 
"nazor", "načas", "način", "nažao", "nehaj", "nekoć", "neman", "nemar", "nemio", "nemir", "nemoć", "nepar", 
"nepce", "nerad", "nered", "nesit", "nesti", "netko", "netom", "nevin", "nećak", "nešto", "neživ", "nijem", 
"nikal", "nimfa", "nisko", "nitko", "nizak", "nišan", "ništa", "njedra", "njegov", "njezin", "nježan", "nježno", 
"njihov", "njisak", "njiska", "njuška", "nokat", "nomad", "nonet", "norma", "nosat", "nosač", "nosiv", "nosni", 
"notes", "notni", "novac", "novak", "noćas", "noćca", "noćni", "nošnja", "nožni", "nujan", "nulti", "nužda", 
"nužno", "obala", "obdan", "obilje", "obiti", "obići", "objed", "oblak", "oblik", "oblić", "oblog", "obnoć", 
"oboje", "obrat", "obraz", "obred", "obris", "obrok", "obrub", "obruč", "obrva", "obuka", "obuti", "obuća", 
"obući", "obzir", "obzor", "ocean", "odaja", "odati", "odbor", "odgoj", "odjek", "odjel", "odljev", "odmah", 
"odmak", "odmor", "odnos", "odora", "odraz", "odred", "odron", "odsad", "odveć", "odvod", "odvoz", "odziv", 
"oganj", "oglas", "ogled", "oklop", "okolo", "okret", "okrug", "oksid", "oktan", "oktet", "okuka", "okvir", 
"olako", "olein", "olovo", "oltar", "oluja", "omara", "omjer", "omlet", "onako", "onamo", "ondje", "oniks", 
"onuda", "opeka", "opera", "opeći", "ophod", "opiti", "opkop", "oprez", "opseg", "optok", "orada", "oranje", 
"orati", "organ", "orkan", "ormar", "oruđe", "oseka", "osinji", "osjet", "oslad", "oslić", "osmak", "osoba", 
"osuda", "osvit", "osvrt", "otada", "otava", "oteti", "oteći", "otići", "otkad", "otkaz", "otkos", "otkud", 
"otkup", "otpad", "otpor", "otrov", "otrti", "otući", "otvor", "ovako", "ovamo", "ovdje", "oveći", "ovjes", 
"ovrha", "ovuda", "ovčar", "ovčji", "ozimi", "očica", "očito", "očnjak", "oštar", "oštro", "padež", "pajac", 
"pakao", "paket", "palac", "paljba", "palma", "pamet", "pampa", "pamuk", "panda", "pandža", "papak", "papar", 
"papir", "paran", "parni", "pasat", "pasha", "pasiv", "pasji", "pasta", "pasti", "patak", "patka", "patnja", 
"pauza", "pačad", "pačić", "pačji", "pažnja", "pegla", "pehar", "pekar", "pelin", "peljar", "pelud", "penat", 
"penis", "pepeo", "perad", "perač", "perce", "perje", "perla", "peron", "petak", "petlja", "petni", "pečat", 
"pečen", "pešće", "pi-pi", "pidžin", "pijan", "pijuk", "pilad", "pilar", "piljak", "pilot", "pipac", "pipak", 
"pirat", "pisac", "pisak", "pisar", "pisač", "pismo", "pista", "pitak", "pitom", "piton", "pizda", "pizza", "pička", "pjega", 
"pjena", "plast", "plato", "plaća", "plašt", "plaža", "pleme", "pleća", "plima", "ploha", "plova", "ploča", 
"pluto", "pluća", "pluće", "podao", "podlo", "podne", "podni", "podno", "poema", "poeta", "pogon", "pohod", 
"pojam", "pojas", "pokaz", "pokoj", "pokop", "pokus", "polen", "polet", "polip", "polis", "polka", "poloj", 
"pomak", "pomno", "pomor", "pomoć", "ponad", "ponor", "ponos", "ponoć", "popis", "poput", "poraz", "pored", 
"porez", "poriv", "porod", "porok", "porta", "posao", "posto", "posve", "potez", "potok", "potom", "potop", 
"pouka", "povez", "povik", "povod", "povoj", "povrh", "poziv", "pozor", "pošip", "pošta", "pošto", "požar", 
"pralja", "pranje", "prase", "pravi", "pravo", "preda", "preko", "prelja", "prema", "preča", "pređa", "preša", 
"prije", "princ", "prior", "prići", "priča", "prišt", "prkos", "prljav", "proba", "prof.", "proso", "prost", 
"proza", "proći", "prsni", "pruga", "pruće", "prvak", "prvaš", "pršut", "pseto", "pseći", "psiha", "psina", 
"ptica", "puder", "puhač", "pumpa", "punac", "punjač", "punđa", "pupak", "puran", "pusta", "putar", "putem", 
"puten", "puzav", "pučki", "pušač", "puška", "pužev", "pužji", "pčela", "pšeno", "rabin", "radar", "radij", 
"radin", "radio", "radič", "radni", "radnja", "rafal", "ragbi", "rahao", "rakun", "rampa", "ranac", "ranjiv", 
"rasan", "rasni", "rasol", "rasti", "ratar", "ratni", "ravan", "ravno", "razni", "razum", "račić", "račji", 
"račun", "račve", "rašlje", "rebro", "rebus", "redak", "redar", "redni", "redom", "regal", "reket", "relej", 
"reljef", "remen", "repaš", "repni", "retor", "reuma", "rever", "rezak", "režim", "ribar", "ribež", "ribiz", 
"ribič", "riblji", "rijas", "riječ", "rikša", "rilce", "ritam", "rizik", "rizom", "rižin", "roblje", "robni", 
"robot", "rodan", "rodni", "rogat", "rogač", "rogoz", "roker", "roman", "romon", "rondo", "rosan", "rotor", 
"rovac", "rovka", "ročni", "rođak", "rubac", "rubin", "rublja", "rublje", "rubni", "rudar", "rudni", "ruglo", 
"rujan", "rukav", "rulet", "rumba", "rumen", "ruski", "rutav", "ručak", "ručka", "ručni", "ružan", "ružno", 
"rvanje", "rzati", "rđati", "sablja", "sabor", "sadnja", "sadra", "sahel", "sajam", "sakat", "salaš", "salon", 
"salpa", "sanjar", "sanjke", "santa", "sapun", "sarma", "satir", "sauna", "savez", "sačma", "sažet", "scena", 
"sedam", "sedef", "sedlo", "sedmi", "sedra", "sekta", "seljak", "senat", "seoba", "serum", "sfera", "shema", 
"sidro", "sijač", "sijed", "silan", "silno", "silom", "silos", "silur", "sinak", "sinod", "sinoć", "sinus", 
"sipak", "sirak", "sirov", "sirup", "sisal", "sitan", "sjati", "sjeme", "sjena", "sjeta", "sjeći", "sječa", 
"skela", "skica", "skija", "sklad", "sklon", "sklop", "skori", "skoro", "skrab", "skupa", "skupo", "skuša", 
"slabo", "slama", "slanje", "slast", "slati", "slava", "sleng", "slika", "slina", "sljeme", "sloga", "slovo", 
"sluga", "smeće", "smilje", "smion", "smjel", "smjer", "smola", "smoći", "smrad", "snaga", "snaha", "snaći", 
"sniti", "sobar", "sobni", "sobom", "sokol", "sonda", "sonet", "sorta", "sorus", "sočan", "speći", "spilja", 
"spjev", "splav", "splet", "spona", "spora", "sporo", "sport", "spram", "sprud", "spust", "srdit", "srdžba", 
"sreća", "srnjak", "srčan", "stado", "staja", "stanje", "start", "stati", "staza", "stega", "stela", "stepa", 
"steći", "stići", "stoga", "stoka", "stopa", "stoti", "strah", "stran", "stres", "stric", "strip", "strka", 
"strog", "stroj", "strop", "strti", "strug", "struk", "stuba", "stvar", "stvor", "sudac", "sudar", "sudnji", 
"suita", "suknja", "sukno", "sukob", "sukut", "sumnja", "sunce", "supka", "surla", "surov", "suton", "sutra", 
"suzan", "suzni", "sućut", "suđen", "sušan", "svaki", "svast", "svađa", "sveza", "svila", "svinja", "sviti", 
"svjež", "svota", "svrab", "svrha", "svuda", "svući", "taban", "tabla", "tabor", "tajan", "tajga", "tajna", 
"tajni", "tajno", "takav", "taksa", "taksi", "talac", "talas", "talog", "taman", "tanad", "tanah", "tanak", 
"tango", "tanjur", "tanko", "tapir", "tavan", "tačke", "tašta", "tekst", "telad", "tempo", "tenis", "tenor", 
"tepih", "terca", "teren", "teret", "terme", "teror", "tesar", "tesla", "tetak", "tetka", "tečaj", "tečan", 
"tečno", "teško", "težak", "težnja", "tifus", "tigar", "tijek", "tikov", "tikva", "tilda", "tinta", "tipka", 
"tisak", "tjeme", "tkalja", "tkanje", "tkati", "tkivo", "tlaka", "tmina", "tobom", "tokar", "tolik", "tonik", 
"topao", "topiv", "toplo", "topot", "torba", "torta", "torzo", "totem", "tovar", "točan", "točka", "točno", 
"traka", "trava", "trbuh", "trema", "trenje", "treći", "trica", "triko", "trkač", "trkom", "trnci", "troje", 
"troji", "tromb", "tropi", "trpak", "trpni", "trsje", "trska", "truba", "trunje", "trupa", "trzaj", "trčak", 
"trčka", "tu-tu", "tubus", "tuljac", "tuljan", "tumač", "tumor", "tumul", "tunel", "tupan", "tučak", "tuđin", 
"tužan", "tužba", "tužno", "ubiti", "ubrus", "udaja", "udalj", "udati", "udica", "udjel", "ufanje", "uglas", 
"uglat", "ugled", "ugljen", "ugljik", "ugoda", "ugriz", "uhoda", "ukras", "ukriž", "ulica", "uliti", "uljani", 
"uljara", "uljast", "uloga", "uludo", "umalo", "umaći", "unija", "unići", "unuka", "unuče", "uopće", "upala", 
"upiti", "upliv", "upola", "uputa", "urbar", "ureći", "urlik", "urota", "ushit", "usjek", "usjev", "uskok", 
"uskrs", "uspio", "uspon", "usput", "usred", "ustav", "usuti", "utaja", "utaći", "uteći", "utiha", "utrka", 
"uvala", "uviti", "uvjet", "uvući", "uzdah", "uzduž", "uzeti", "uzgoj", "uzgon", "uzica", "uzlaz", "uzlet", 
"uzmah", "uznik", "uzrok", "uzvik", "učenje", "učiti", "ušara", "ušata", "ušica", "ušiti", "ušljiv", "uštap", 
"užina", "uživo", "vagon", "valjak", "valjan", "valjda", "valni", "vapaj", "vapno", "varav", "varka", "varoš", 
"vatra", "vazal", "vazda", "važan", "vedar", "velar", "velik", "velim", "veoma", "vepar", "veseo", "veslo", 
"vesti", "vezir", "večer", "vidan", "vidik", "vidni", "vidno", "vidra", "vihor", "vijak", "vijek", "vikar", 
"vinar", "vinil", "vinjak", "vinov", "viola", "virus", "visak", "viski", "visok", "vitak", "vitao", "vitez", 
"vitlo", "viđen", "višak", "višnja", "vjera", "vjeđa", "vješt", "vlada", "vlaga", "vlast", "voden", "vodik", 
"vodič", "vodni", "vojni", "vokal", "volak", "volan", "voljka", "voljni", "vosak", "votka", "vozač", "vozni", 
"voćar", "voćka", "voćni", "vožnja", "vrana", "vrata", "vrelo", "vrenje", "vreti", "vreva", "vreća", "vrhnje", 
"vrlet", "vrsta", "vrtni", "vrtnja", "vrulja", "vršak", "vršni", "vučić", "vučji", "vučni", "zabat", "zabit", 
"zadah", "zadak", "zadnji", "zahod", "zajam", "zakon", "zakup", "zalaz", "zalet", "zaljev", "zalog", "zamah", 
"zamak", "zambi", "zamet", "zamka", "zamor", "zanat", "zanos", "zaova", "zapad", "zapis", "zapor", "zapuh", 
"zarez", "zatim", "zaton", "zator", "zavod", "zavoj", "začas", "začin", "zašto", "zbilja", "zbiti", "zbrka", 
"zbroj", "zdrav", "zebnja", "zebra", "zelen", "zemlja", "zemni", "zenit", "zečić", "zečji", "zglob", "zgoda", 
"zidar", "zimus", "zipka", "zirak", "zjena", "zlato", "zloba", "zmija", "znanje", "znati", "zobun", "zoran", 
"zraka", "zreti", "zrnce", "zubac", "zubar", "zubat", "zubni", "zvanje", "zvati", "zvono", "ćelav", "ćilim", 
"ćuška", "čabar", "čamac", "čaplja", "časak", "časno", "čavao", "čavka", "čaška", "čedan", "čekić", "čekrk", 
"čelik", "čeljad", "čelni", "čemer", "čeoni", "čepić", "često", "četka", "četri", "češer", "češki", "čežnja", 
"čigra", "čiopa", "čipka", "čislo", "čisto", "čitak", "čitav", "čitač", "čizma", "čičak", "čokot", "čopor", 
"čudak", "čudan", "čudno", "čujan", "čulan", "čupav", "čuvar", "čvrga", "čvrst", "đakon", "đavao", "đački", 
"đeram", "đuveč", "šabat", "šakal", "šakač", "šaljiv", "šaman", "šamar", "šamot", "šansa", "šapat", "šaran", 
"šaren", "šator", "šačni", "šašav", "šegrt", "šepav", "šerif", "šesti", "šesto", "šetač", "šetnja", "šećer", 
"šešir", "šiblje", "šifra", "šiljak", "šiljat", "šipak", "šipka", "širok", "širom", "šivač", "šiška", "šiške", 
"škamp", "škare", "škljoc", "škola", "škrga", "škrob", "škrto", "škver", "šljiva", "šljuka", "šogor", "šojka", 
"špaga", "špilja", "šport", "štaka", "štala", "štand", "štene", "šteta", "štivo", "štuka", "šugav", "šuman", 
"šumar", "šumni", "šumor", "šunka", "šurla", "šutke", "šutnja", "šuška", "švelja", "šverc", "žabac", "žablji", 
"žalac", "žalar", "žalba", "žamor", "žarki", "žarni", "žbica", "žbuka", "žbunje", "ždral", "žedan", "željan", 
"željen", "želva", "žemlja", "ženik", "ženka", "žeton", "žetva", "žezlo", "žgoljo", "židak", "židov", "žilav", 
"žilet", "žilni", "živac", "živin", "živio", "život", "žičan", "žlica", "žohar", "žrtva", "žubor", "žudnja", 
"žumor", "župan", "župni", "žuran", "žurba", "žurno", "žućak", "žučan", "žučni", "žvaka"
];
